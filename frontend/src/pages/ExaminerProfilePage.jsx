      ...
      <div style={{ maxWidth: 500, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" stroke={C.orange} strokeWidth="1.5" style={{ width: 44, height: 44 }}>
            ...
            <div style={{ fontSize: 13, color: C.muted, marginTop: 4 }}>Examiner</div>
          </div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  borderRadius: 8,
                  background: loading ? "#cbd5e1" : C.orange,
                  color: "#fff",
                  fontSize: 14,
                  fontWeight: 600,
